...
export const documentation: DocumentationDocument[] = [
	...
	{ id: 'email-scam-detector', title: 'Email Scam Detector', description: 'Detect potential phishing emails using the Rocky API.', category: 'examples', audience: 'all', order: 4, path: '/docs/developer/email-scam-detector.md' },
