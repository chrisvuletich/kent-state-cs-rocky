export type FrameName = 'dashboard' | 'users' | 'courses' | 'analytics' | 'admin' | 'audit' | 'account' | 'chat' | 'help';
...
const adminFrames: FrameName[] = ['dashboard', 'users', 'courses', 'admin', 'audit', 'account', 'chat', 'help'];
