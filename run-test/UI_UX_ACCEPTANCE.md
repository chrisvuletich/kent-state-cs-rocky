...
- Keep the release suite green while making changes. Add a regression test with
  the fix for the behavior it protects.
...
### Final regression and intern handoff
